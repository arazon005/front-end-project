...
const $atk = document.querySelector('.atk') as HTMLElement;
const $def = document.querySelector('.def') as HTMLElement;
const $level = document.querySelector('.level') as HTMLElement;
const $modalPot = document.querySelector('.modal-pot') as HTMLImageElement;
...
const $classIcon = document.querySelector('.class-icon') as HTMLImageElement;
const $skills = document.querySelectorAll('.skill-level');
const $s1Name = document.querySelector('.s1-name') as HTMLElement;
const $s2Name = document.querySelector('.s2-name') as HTMLElement;
const $s3Name = document.querySelector('.s3-name') as HTMLElement;
...
let $favElements: NodeList;
let $ownElements: NodeList;
let $editElements: NodeList;
...
function editModal(i: number): void {
...
function levelCap(p: number): number {
  if (p === 0) {
    return 50;
  } else if (p === 1) {
    return 80;
...
function calculateHp(i: number): number {
  const promotion: number = operators[i].promotion;
  const reference = Object.values(operators[i].statistics) as any;
...
function calculateAtk(i: number): number {
  const promotion: number = operators[i].promotion;
  const reference = Object.values(operators[i].statistics) as any;
...
function calculateDef(i: number): number {
  const promotion: number = operators[i].promotion;
  const reference = Object.values(operators[i].statistics) as any;
...
function checkSkills(id: number): boolean {
